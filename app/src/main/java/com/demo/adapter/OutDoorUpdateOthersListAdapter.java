...
public class OutDoorUpdateOthersListAdapter extends BaseAdapter {
    private Context mContext;
    private List<OutDoorHistory> attendenceHisData = new ArrayList<>();
    private LayoutInflater inflter;
    private OutDoorWorkEntryOtherDetailsFragment outDoorWorkEntryOtherDetailsFragment;

    public OutDoorUpdateOthersListAdapter(Context applicationContext, List<OutDoorHistory> attendenceHisData, OutDoorWorkEntryOtherDetailsFragment outDoorWorkEntryOtherDetailsFragment) {
        this.mContext = applicationContext;
        this.attendenceHisData = attendenceHisData;
        inflter = (LayoutInflater.from(applicationContext));
        this.outDoorWorkEntryOtherDetailsFragment = outDoorWorkEntryOtherDetailsFragment;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        tv_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                outDoorWorkEntryOtherDetailsFragment.displayView(fragment);
